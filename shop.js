...
Versión final: anti-abuso de cupones + pagos + fallback + BD
✅ Iconos Font Awesome (juvenil-premium)
============================================================ */
(function() {
"use strict";
const C = typeof SITE_CONFIG !== 'undefined' ? SITE_CONFIG : {};
 let PRODUCTS = C.ecommerce.products || []; // respaldo si la BD está vacía
 // ★ Cliente compartido para órdenes y cupones
 ...
 async function checkoutWithCard() {
     ...
     try {
         // ✅ Registrar cupón antes de redirigir a Mercado Pago
         if (appliedPromoCode) {
 ...
 // ============================================
 // 🛡️ CONTROL DE USO DE CUPONES (1 por persona/navegador)
 // ============================================
 ...
 function renderModalContent() {
     ...
     // ✅ Añadir botón de cerrar con Font Awesome
 ...
 function closeProductModal() {
  ...
  function initModalGallery() {
     // ✅ Delegación: funciona también con miniaturas agregadas dinámicamente
 ...
 // ✅ Sincroniza la galería con la variante seleccionada
 function syncGalleryWithVariant(product, variant) {
     ...
     // Si la imagen de la variante no está en la galería, la agregamos
     if (idx === -1) {
         idx = slides.length;
 ...
 async function handleApplyPromo() {
    ...
    // ✅ Consultar el cupón directamente en la BD (ya no usa config.js)
    ...
    setTimeout(() => {
        // Construir el objeto con los datos de la BD
        appliedPromoCode = { 
            code: code, 
            type: promoData.type, 
 ...
 function initEvents() {
     ...
     if (checkoutBtn) {
         checkoutBtn.addEventListener("click", async () => {
             ...
             msg += `\n*💰 Total a pagar: $${total}*`;
             // ✅ Registrar cupón como usado (1 por persona) + conteo global
             if (appliedPromoCode) {
                 markCouponUsed(appliedPromoCode.code);
                 bumpCouponUsage(appliedPromoCode.code);
             }
     ...
     // 💳 Botón de tarjeta (solo si está activo en config.js)
 ...
 function initStorageSync() {
  ...
  // ✅ Promociones del popup desde la BD (cupones con show_in_popup)
 ...
 async function initPromoPopup() {
    ...
    // ✅ Items desde BD; si no hay, respaldo en config.js
 ...
 function initWhatsAppButton() {
    ...
    // ✅ Icono FA (el botón ya centra con flex)
    ...
    function checkScrollPosition() {
        ...
        // ✅ Progreso real: 0 = arriba, 1 = abajo (funciona en páginas cortas y largas)
