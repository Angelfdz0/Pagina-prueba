...
(function() {
    ...
    // Evita la "segunda barra" de la página de fondo
    // ============================================
    function lockScroll() {
    ...
    function init() {
        ...
        initEvents();
        initScrollEffects();
        initModalKeyboard(); // ★ Teclado del modal se registra UNA sola vez
        initPromoPopup();
        initWhatsAppButton();
    }
    ...
    function closeProductModal() {
        ...
        unlockScroll(); // ★ Restaura body + html
    }

    // ★ GALERÍA DEL MODAL (solo clicks de miniaturas)
    ...
    // ★ TECLADO DEL MODAL (se registra UNA sola vez, no se acumula)
    ...
    function initPromoPopup() {
        ...
        function startRotation() {
            ...
            window.promoRotateTimer = setInterval(nextPromo, interval); // ★ Timer global
        }
    ...
    // Llamar al iniciar (ÚNICO punto de arranque)
